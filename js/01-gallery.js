...
//        }  else { (foundationList.scrollTop + foundationList.offsetHeight >= foundationList.scrollHeight) 
...
//     if (!up) {
//         foundationList.scrollBy(0, -300);
//        }  else { (foundationList.scrollTop === 0) 
//             supportBtn.innerHTML = `<svg width="20" height="20"><use href="./img/sprite.svg#icon-down-arrow"></use></svg>`;
//             up = false;
//           return;
//         }     
...
//     if (!up) {
//         foundationList.scrollBy({ top: scrollStep, behavior: 'smooth' });
//     } else {
//         foundationList.scrollBy({ top: -scrollStep, behavior: 'smooth' });
//     }

//     // Update the button icon after scrolling
...
//         supportBtn.innerHTML = `<svg width="20" height="20"><use href="./img/sprite.svg#icon-down-arrow"></use></svg>`;
//         up = false;
//     } else if (foundationList.scrollTop + foundationList.offsetHeight >= foundationList.scrollHeight) {
//         supportBtn.innerHTML = `<svg width="20" height="20"><use href="./img/sprite.svg#icon-up-arrow"></use></svg>`;
//         up = true;
//     }
// }
